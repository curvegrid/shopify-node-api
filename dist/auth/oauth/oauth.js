            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, context_1.Context.SESSION_STORAGE.loadSession(ShopifyOAuth.getOfflineSessionId(query.shop))];
                    case 3:
                        currentSession = _a.sent();
                        _a.label = 4;
                    case 4:
                    ...
                    case 5:
                        ...
                        if (!currentSession.isOnline) return [3 /*break*/, 8];
                    ...
                    case 8:
                        ...
                        _a.label = 9;
                    case 9: return [4 /*yield*/, context_1.Context.SESSION_STORAGE.storeSession(currentSession)];
                    case 10:
                        sessionStored = _a.sent();
                        if (!sessionStored) {
                            throw new ShopifyErrors.SessionStorageError('OAuth Session could not be saved. Please check your session storage functionality.');
